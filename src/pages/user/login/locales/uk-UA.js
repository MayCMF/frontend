export default {
  'user-login.login.userName': 'Логін',
  'user-login.login.password': 'Пароль',
  'user-login.login.message-invalid-credentials':
    'Не вірний логін або пароль',
  'user-login.login.message-invalid-verification-code': 'Недійсний код підтвердження',
  'user-login.login.tab-login-credentials': 'Credentials',
  'user-login.login.tab-login-mobile': 'Mobile number',
  'user-login.login.remember-me': 'Запам\'ятапати мене',
  'user-login.login.forgot-password': 'Забули свій пароль?',
  'user-login.login.sign-in-with': 'Увійти через:',
  'user-login.login.signup': 'Зареєструватись',
  'user-login.login.login': 'Вхід',
  'user-login.register.register': 'Зареєструватись',
  ...
  'user-login.userName.required': 'Будь ласка, введіть ім\'я користувача!',
  'user-login.password.required': 'Введіть свій пароль!',
  'user-login.password.twice': 'Введені двічі паролі не збігаються!',
  'user-login.strength.msg':
    "Введіть принаймні 6 символів і не використовуйте паролі, які легко вгадати.",
  ...
  'user-login.verification-code.placeholder': 'Код підтвердження',
